...
export const CourseCard = (props) => {
    ...
    return (
        <div style={isDetailBanner ? { position: "absolute" }:{}} className={`card shadow border-0 ${styles.servicesCard}`}>
            ...
            <div className={`card-body ${styles.servicesCardBody}`}>
                ...
                <button onClick={handleRouteDetail} type="button" className={`btn btn-primary btn-lg btn-block w-100 ${styles.servicesCardButton}`}>View Detail</button>
            </div>
        </div>
    )
